...
const baseLightColors = {
  ...
  cardLavender: "#EDE8FF",
  cardPeach: "#FFEAD7",
  quickActionBrowseSurface: "#EAF4FF",
  quickActionBrowseForeground: "#255B84",
  quickActionDealsSurface: "#FCECF3",
  quickActionDealsForeground: "#8D3E5B",
  quickActionOrdersSurface: "#EAF7F1",
  quickActionOrdersForeground: "#2F6B56",
  quickActionFavouritesSurface: "#F2EEFA",
  quickActionFavouritesForeground: "#5D4B89",
...
const baseDarkColors: ThemeColors = {
  ...
  cardLavender: "#2A2348",
  cardPeach: "#3B2A1A",
  quickActionBrowseSurface: "#172536",
  quickActionBrowseForeground: "#9CC7EF",
  quickActionDealsSurface: "#30202A",
  quickActionDealsForeground: "#F0A9C1",
  quickActionOrdersSurface: "#173027",
  quickActionOrdersForeground: "#9AD1B8",
  quickActionFavouritesSurface: "#28223A",
  quickActionFavouritesForeground: "#C5B6EC",
